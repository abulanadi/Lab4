...
namespace Lab4
{
	class NaiveQuick
	{
		...
		{
			Console.WriteLine("Testing naive quicksort...");
			...
			Sort(testList1, 0, testList1.Length - 1);
			...
			Sort(testList2, 0, testList2.Length - 1);
			...
			Sort(testList3, 0, testList3.Length - 1);
		...
		public void RunFullNaiveQuickSorted(string resultFile)
		{
			Stopwatch stopwatch = new Stopwatch();
